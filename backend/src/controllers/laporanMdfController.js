...
const extractFields = (body) => {
  ...
  // Gunakan || null agar kompatibel dengan Node.js v12 (tidak support ??)
  return [
    kiri_raw_thickness  !== undefined ? kiri_raw_thickness  : null,
    kiri_fin_thickness  !== undefined ? kiri_fin_thickness  : null,
    kiri_good_board     !== undefined ? kiri_good_board     : null,
    kiri_m3_goodboard   !== undefined ? kiri_m3_goodboard   : null,
    kiri_total_reject   !== undefined ? kiri_total_reject   : null,
    kiri_m3_reject      !== undefined ? kiri_m3_reject      : null,
    kiri_total_board    !== undefined ? kiri_total_board    : null,
    kiri_total_board_m3 !== undefined ? kiri_total_board_m3 : null,
    kiri_gluemix        !== undefined ? kiri_gluemix        : null,
    kiri_paraffin       !== undefined ? kiri_paraffin       : null,
    kiri_fibre          !== undefined ? kiri_fibre          : null,
    kiri_wood           !== undefined ? kiri_wood           : null,
    kiri_jenis          !== undefined ? kiri_jenis          : null,
    kanan_raw_thickness  !== undefined ? kanan_raw_thickness  : null,
    kanan_fin_thickness  !== undefined ? kanan_fin_thickness  : null,
    kanan_good_board     !== undefined ? kanan_good_board     : null,
    kanan_m3_goodboard   !== undefined ? kanan_m3_goodboard   : null,
    kanan_total_reject   !== undefined ? kanan_total_reject   : null,
    kanan_m3_reject      !== undefined ? kanan_m3_reject      : null,
    kanan_total_board    !== undefined ? kanan_total_board    : null,
    kanan_total_board_m3 !== undefined ? kanan_total_board_m3 : null,
    kanan_gluemix        !== undefined ? kanan_gluemix        : null,
    kanan_paraffin       !== undefined ? kanan_paraffin       : null,
    kanan_fibre          !== undefined ? kanan_fibre          : null,
    kanan_wood           !== undefined ? kanan_wood           : null,
    kanan_jenis          !== undefined ? kanan_jenis          : null,
    hambatan,
  ];
};
